            ...
            <div class="col-md-6">
                <form action="{{ route('samples.update', $data->id)}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('audio_file') is-invalid @enderror" id="audio_file" placeholder="Upload audio_file"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Enter description"
                    ...
                    <div class="mb-3">
                        ...
                        {{--            input type will be changed when audio file implementation--}}
                        <input type="text" class="form-control @error('cover') is-invalid @enderror" id="cover" placeholder="Upload cover"
